...
// Función para generar slug SEO-friendly (debe coincidir con la del componente)
function generateSlug(brand: string, model: string, cpuModel: string, graphicsModel: string): string {
